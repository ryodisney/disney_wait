...
def Sea_dict(area):
    dic = {}
    dic["メディテレーニアンハーバー"] =["ヴェネツィアン・ゴンドラ","フォートレス・エクスプロレーション","ディズニーシー･プラザ","トランジットスチーマーライン"]
    dic["アメリカンウォーターフロント"] = ["タワー・オブ・テラー","タートル・トーク","トイ・ストーリー・マニア！","ビッグシティ・ヴィークル","ヴィレッジ・グリーティングプレイス","トランジットスチーマーライン","エレクトリックレールウェイ","ウォーターフロントパーク","ケープコッド・クックオフ横"]
    dic["ポートディスカバリー"] = ["アクアトピア","レールウェイ","ニモ＆フレンズ・シーライダー"]
    dic["ロストリバーデルタ"] = ["インディージョーンズ","スチーマーライン","レイジングスピリッツ","グリーティングドック","グリーティングトレイル(グーフィー)","グリーティングトレイル(ミニーマウス)","グリーティングトレイル(ミッキーマウス)"]
    dic["アラビアンコースト"] = ["キャラバンカルーセル","シンドバット","フライングカーペット","マジックランプシアター","アラビアンコースト"]
    dic["マーメイドラグーン"] = ["アリエルグリーティング","プレイグラウンド","ジェリーフィッシュ","スカットルのスクーター","フィッシュコースター","バルーンレース","マーメイドラグーンシアター","ワームプール"]
    dic["ミステリアスアイランド"] = ["海底2万マイル","センター・オブ・ジ・アース"]
