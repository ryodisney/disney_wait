...
def Land_dict(area):
    ...
    dic["トゥーンタウン"] = ["ガジェットのゴーコースター","グーフィーのプレイハウス","チップとデールのツリーハウス","トゥーンパーク","ドナルドのボート","ミート・ミッキー","ミニーの家","カートゥーンスピン"]
    dic["トゥモローランド"] = ["スターツアーズ","スペース・マウンテン","バズ・ライトイヤー","モンスターズ・インク","スティッチ・エンカウンター"]
    dic["ウエスタンランド"] = ["シューティングギャラリー","カントリーベア","マークトウェイン号","トムソーヤ島いかだ","ビッグサンダー","グリーティング（デイジー）","グリーティング（ドナルド）"]
    dic["クリッターカントリー"] = ["スプラッシュ","カヌー探検"]
    dic["ファンタジーランド"] = ["アリスのティーパーティー","スモールワールド","キャッスルカルーセル","白雪姫","シンデレラのフェアリーテイル","空飛ぶダンボ","ピノキオの冒険旅行","ピーターパン","ハニーハント","ホーンテッドマンション","フィルハーマジック"]
